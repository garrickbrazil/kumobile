...
n.abort=function(){null!=o&&(o.abort(),o=null)},n.search=function(t,i,n,l,d,c,h){if(void 0==h)var h=0
if(null!=o)return void c("One search is already occurring. Please cancel first.")
...
var o=$("h3",this).text(),l=$(".info .location",this).text(),d=$(".tags",this).text(),c=$("h3 a",this).attr("href")
...
s=$.ajax({url:l,type:"GET",dataType:"html",success:function(a){var o=[],l=$("<div>").html(a),c=l.find(".hit_list_row"),h=l.find("#hitlist").first().attr("action")
r={action:h,field:t,searchOptionId:i,page:d},c.each(function(t){if($(".hit_list_list_cover script",this).length>0){var i=$(".hit_list_list_cover script",this).eq(0).text().replace(/\s/g,"").replace("getHitCover('","").replace("');",""),r="",s=i.split("','")
...
var s=$("<div>").html(r),n=function(t){return t.text().trim().toLowerCase()},a=/[a-zA-Z]+\s+\d\d\d\d/,o=/\$0+(\.0+)?/,l="0",d=[],c=[],h="",u="",m="",f="",p="",v="",g="",x=""
$(".datadisplaytable",s).find("tr").each(function(){if(1==$("th",this).size()&&1==$("td",this).size()){var t=n($("th",this).eq(0)),i=$("td",this).eq(0).text().trim()
"account balance:"===t?l=i:"term charges:"===t?u=i:"term credits and payments:"===t?m=i:"term balance:"===t&&(f=i,d[d.length]=new e.JWEB.AccountTerm(h,u,m,f,c),c=[],h="",u="",m="",f="",p="",v="",g="",x="")}else if(1==$("th",this).size()&&0==$("td",this).size()){var t=$("th",this).eq(0).text().trim()
a.test(t)&&(h=t)}else 5==$("td",this).size()?(v=$("td",this).eq(0).text().trim(),g=$("td",this).eq(1).text().trim(),charge=$("td",this).eq(2).text().trim(),credit=$("td",this).eq(3).text().trim(),x=""==charge?credit:o.test(charge)?charge:"-"+charge,c[c.length]=new e.JWEB.AccountEntry(v,g,x)):5==$("td",this).size()&&(v=$("td",this).eq(0).text().trim(),g=$("td",this).eq(1).text().trim(),charge=$("td",this).eq(2).text().trim(),credit=$("td",this).eq(3).text().trim(),x=""==charge?credit:o.test(charge)?charge:"-"+charge,c[c.length]=new e.JWEB.AccountEntry(v,g,x))}),t(l,d)},error:function(t,e,r){i(r)}})},retrieveCurrentHolds:function(t,e){var i="http://jweb.kettering.edu/cku1/bwskoacc.P_ViewHold"
...
$("table.plaintable",r).each(function(){s||"This layout table holds message information"!=$(this).attr("summary").trim()||(t($(this).html()),s=!0)}),s||t("Nothing to show!")},error:function(t,i,r){e(r)}})},retrieveTranscript:function(t,e){var i="https://jweb.kettering.edu/cku1/ku_web_trans.view_transcript?tprt=SHRTRTC&levl=U"
$.ajax({url:i,type:"POST",dataType:"html",success:function(i){if(KU.Student.JWEB.isErrorPage(i))return void e("Request failed")
var r=$("<div>").html(i)
t(r.html())},error:function(t,i,r){e(r)}})},retrieveAwardHistory:function(t,i){var r="https://jweb.kettering.edu/cku1/bwrkrhst.P_DispAwdHst"
$.ajax({url:r,type:"GET",dataType:"html",success:function(r){if(KU.Student.JWEB.isErrorPage(r))return void i("Request failed")
...
var s=$("<div>").html(t),n=[],a="",o="",l="",d="",c="",h="",u="",m="",f="",p="",v="",g="",x="",b=""
s.find("table.datadisplaytable tr").each(function(){var t=$("td",this)
17==t.size()&&(""!=t.eq(1).text().trim()&&(a=t.eq(0).text().trim(),o=t.eq(1).text().trim(),l=t.eq(2).text().trim()+"-"+t.eq(3).text().trim(),d=t.eq(4).text().trim(),c=t.eq(5).text().trim(),h=t.eq(6).text().trim(),u=t.eq(7).text().trim()),m=t.eq(8).text().trim(),f=t.eq(9).text().trim(),p=t.eq(10).text().trim(),v=t.eq(11).text().trim(),g=t.eq(13).text().trim(),x=t.eq(14).text().trim(),b=t.eq(15).text().trim(),n[n.length]=new e.JWEB.CatalogEntry(a,o,l,d,c,h,u,m,f,p,v,g,x,b))}),i(n)},error:function(t,e,i){r(i)}})},retrieveScheduleTerms:function(t,e){var i="https://jweb.kettering.edu/cku1/bwskflib.P_SelDefTerm"
$.ajax({url:i,type:"GET",dataType:"html",success:function(i){if(KU.Student.JWEB.isErrorPage(i))return void e("Request failed")
var r=$("<div>").html(i),s=[]
r.find("#term_id option").each(function(){s[s.length]=$(this).val()}),t(s)},error:function(t,i,r){e(r)}})},retrieveFinalTerms:function(t,e){var i="https://jweb.kettering.edu/cku1/wbwskogrd.P_ViewTermGrde"
$.ajax({url:i,type:"GET",dataType:"html",success:function(i){if(KU.Student.JWEB.isErrorPage(i))return void e("Request failed")
var r=$("<div>").html(i),s=[]
r.find("#term_id option").each(function(){s[s.length]=$(this).val()}),t(s)},error:function(t,i,r){e(r)}})},retrieveFinalGrades:function(t,i,r){var s="https://jweb.kettering.edu/cku1/wbwskogrd.P_ViewGrde?term_in="+t+"&inam=on&snam=on&sgid=on"
$.ajax({url:s,type:"GET",dataType:"html",success:function(t){if(KU.Student.JWEB.isErrorPage(t))return void r("Request failed")
...
var t=children.eq(0).text().trim(),i=children.eq(1).text().trim()+"-"+children.eq(2).text().trim(),r=children.eq(3).text().trim(),s=children.eq(4).text().trim(),c=children.eq(5).text().trim(),h=children.eq(6).text().trim(),u=children.eq(8).text().trim()
d[d.length]=new e.JWEB.FinalGrade(t,i,r,s,c,h,u)}1==$("th",this).size()&&5==$("td",this).size()&&(label=n($("th",this).eq(0)),gpaInfo=$("td",this).eq(4).text().trim(),"current term:"===label&&(o=gpaInfo),"overall:"===label&&(l=gpaInfo))})}),i(a,o,l,d)},error:function(t,e,i){r(i)}})},generateEvaluation:function(t,e,i,r,s){var n="https://jweb.kettering.edu/cku1/bwckcapp.P_Submit?source1="+t+"&program="+e+"&ctlg_term="+i+"&eval_term=999999&dflt_ip=Y"
$.ajax({url:n,type:"GET",dataType:"html",success:function(t){return KU.Student.JWEB.isErrorPage(t)?void s("Request failed"):void r()},error:function(t,e,i){s(i)}})},retrieveEvalPrograms:function(t,i,r){var s="https://jweb.kettering.edu/cku1/bwckcapp.P_DispEvalTerm?term_in="+t
$.ajax({url:s,type:"GET",dataType:"html",success:function(t){if(KU.Student.JWEB.isErrorPage(t))return void r("Request failed")
var s=$("<div>").html(t)
programs=[]
var n=s.find("input[name=source1]").attr("value")
s.find("table.dataentrytable").each(function(){programId=$("input[name=program]",this).attr("value"),name=$("tr:first td:last",this).text().trim(),programs[programs.length]=new e.JWEB.EvalProgram(name,n,programId)}),i(programs)},error:function(t,e,i){r(i)}})},retrieveEvaluation:function(t,i,r,s){var n="https://jweb.kettering.edu/cku1/bwckcapp.P_DispCurrent?term_in="+t
$.ajax({url:n,type:"GET",dataType:"html",success:function(t){if(KU.Student.JWEB.isErrorPage(t))return void s("Request failed")
var n="https://jweb.kettering.edu/cku1/bwckcapp.P_VerifyDispEvalViewOption?request_no="+i+"&program_summary=3"
$.ajax({url:n,type:"GET",dataType:"html",success:function(t){if(KU.Student.JWEB.isErrorPage(t))return void s("Request failed")
...
var a,o="",l="",d="",c="",h="",u="",m="",f="",p="",v="",g=/(\d\d\d\d+)\s(.*)\n.*/,x=g.exec($(".staticheaders",i).text().trim())
...
for(t=0;t+1<e.size();t+=2)"college :"===n(e.eq(t))&&(o=e.eq(t+1).text().trim()),"degree :"===n(e.eq(t))&&(l=e.eq(t+1).text().trim()),"level :"===n(e.eq(t))&&(d=e.eq(t+1).text().trim()),"majors :"===n(e.eq(t))&&(c=e.eq(t+1).text().trim().replace(/\n+/g,", ")),"catalog term :"===n(e.eq(t))&&(h=e.eq(t+1).text().trim()),"expected graduation date :"===n(e.eq(t))&&(a=e.eq(t+1).text().trim()),"results as of :"===n(e.eq(t))&&(u=e.eq(t+1).text().trim()),"minors :"===n(e.eq(t))&&(m=e.eq(t+1).text().trim().replace(/\n+/g,", ")),"concentrations :"===n(e.eq(t))&&(f=e.eq(t+1).text().trim().replace(/\n+/g,", ")),f=f.replace(/\n+/g,", ")})
var b="",w="",_="",y="",q="",E="",T="",k=""
i.find("table.datadisplaytable").eq(1).find("tr").each(function(){1==$("th",this).size()&&5==$("td",this).size()&&("total required :"===n($("th",this))&&(b="yes"===n($("td",this).eq(0)),w=$("td",this).eq(1).text().trim(),_=$("td",this).eq(2).text().trim()),"program gpa :"===n($("th",this))&&("yes"===n($("td",this).eq(0))?q=!0:"no"===n($("td",this).eq(0))&&(q=!1),T=$("td",this).eq(2).text().trim()),"overall gpa :"===n($("th",this))&&("yes"===n($("td",this).eq(0))?E=!0:"no"===n($("td",this).eq(0))&&(E=!1),k=$("td",this).eq(2).text().trim()),"transfer :"===n($("th",this))&&(y=$("td",this).eq(2).text().trim()))})
for(var j=[],I=/([a-zA-Z\s]+)\s*\(\s*(\d+\.\d+)\scredits\s*\)\s*-\s*(.*)/,B=2;B<i.find("table.datadisplaytable").size();B++){var C="",S="",P="",A="",U="",z="",G="",N="",J="",R="",w="",O="",W="",K=[],D=[]
...
i.details=G,K[K.length]=i}D=[],C="",S="",P="",A="",U="",z="",N="",G="",R=groups[1],w=groups[2],J="Met"==groups[3]}else if(17==$("td",this).size()){children=$("td",this)
var r=n(children.eq(1))
for(var t in D){var i=D[t]
i.details=G,K[K.length]=i}D=[],C="",S="",P="",A="",U="",z="",N="",G="",C="yes"===n(children.eq(0)),S=children.eq(3).text().trim()+"-"+children.eq(5).text().trim(),P=children.eq(10).text().trim()+"-"+children.eq(11).text().trim(),A=children.eq(12).text().trim(),U=children.eq(9).text().trim(),z=children.eq(14).text().trim(),N=children.eq(15).text().trim(),(""===S||"-"===S)&&(S=children.eq(2).text().trim()),""!=S&&(K[K.length]=new e.JWEB.EvalCourse(C,S,P,A,U,z,N,G),C="",S="",P="",A="",U="",z="",N="",G="")}else if(12==$("td",this).size()){children=$("td",this)
for(var t in D){var i=D[t]
i.details=G,K[K.length]=i}D=[],C="",S="",P="",A="",U="",z="",N="",G="",C="yes"===n(children.eq(0)),S=children.eq(3).text().trim(),P=children.eq(5).text().trim()+"-"+children.eq(6).text().trim(),A=children.eq(7).text().trim(),U=children.eq(4).text().trim(),z=children.eq(9).text().trim(),N=children.eq(10).text().trim(),(""===S||"-"===S)&&(S=children.eq(2).text().trim()),""!=S&&(D[D.length]=new e.JWEB.EvalCourse(C,S,P,A,U,z,N,G),C="",P="",A="",U="",z="",N="",G="")}else if(10==$("td",this).size()&&"8"==$("td",this).eq(9).attr("colspan")){children=$("td",this)
var r=n(children.eq(1))
for(var t in D){var i=D[t]
i.details=G,K[K.length]=i}D=[],C="",S="",P="",A="",U="",z="",N="",G="",C="yes"===n(children.eq(0)),S=children.eq(3).text().trim()+"-"+children.eq(5).text().trim(),(""===S||"-"===S)&&(S=children.eq(2).text().trim()),""==S||"("!==r&&")"!==r&&")and("!==r&&"and"!==r||(K[K.length]=new e.JWEB.EvalCourse(C,S,P,A,U,z,N,G),C="",S="",P="",A="",U="",z="",N="",G="")}else if(10==$("td",this).size())children=$("td",this),C=null,G=children.eq(1).text().trim(),P=children.eq(3).text().trim()+"-"+children.eq(4).text().trim(),A=children.eq(5).text().trim(),U=children.eq(2).text().trim(),z=children.eq(7).text().trim(),N=children.eq(8).text().trim(),""!=S&&(D[D.length]=new e.JWEB.EvalCourse(C,S,P,A,U,z,N,G),C="",P="",A="",U="",z="",N="")
else if(3==$("td",this).size()&&"8"==$("td",this).eq(2).attr("colspan"))children=$("td",this),G=children.eq(1).text().trim()
else if(8==$("td",this).size())children=$("td",this),C=null,P=children.eq(1).text().trim()+"-"+children.eq(2).text().trim(),A=children.eq(3).text().trim(),U=children.eq(0).text().trim(),z=children.eq(5).text().trim(),N=children.eq(6).text().trim(),""!=S&&(D[D.length]=new e.JWEB.EvalCourse(C,S,P,A,U,z,N,G),C="",P="",A="",U="",z="",N="")
else if(2==$("td",this).size()){if(children=$("td",this),")"===children.eq(1).text().trim())for(var t in D){var i=D[t]
i.details=G,K[K.length]=i}D=[],C="",S="",P="",A="",U="",z="",N="",G=""}else if(5==$("td",this).size()&&"8"==$("td",this).eq(4).attr("colspan")){children=$("td",this)
for(var t in D){var i=D[t]
i.details=G,K[K.length]=i}D=[],C="",S="",P="",A="",U="",z="",N="",G="",C="yes"===n(children.eq(0)),S=children.eq(3).text().trim(),P=children.eq(5).text().trim()+"-"+children.eq(6).text().trim(),(""===S||"-"===S)&&(S=children.eq(2).text().trim()),""!=S&&(D[D.length]=new e.JWEB.EvalCourse(C,S,P,A,U,z,N,G),C="",P="",A="",U="",z="",N="",G="")}else if(4==$("td",this).size()){children=$("td",this)
for(var t in D){var i=D[t]
i.details=G,K[K.length]=i}D=[],C="",S="",P="",A="",U="",z="",N="",G="",O=children.eq(1).text().trim(),W=children.eq(2).text().trim()}}),""!=R&&(j[j.length]=new e.JWEB.EvalArea(J,R,w,O,W,K))}evaluation=new e.JWEB.Evaluation(p,v,o,l,d,c,h,a,u,m,f,b,w,_,y,q,E,T,k,j),r(evaluation)},error:function(t,e,i){s(i)}})},error:function(t,e,i){s(i)}})},retrieveEvaluationList:function(t,e,i){var r="https://jweb.kettering.edu/cku1/bwcksmmt.P_DispPrevEval?term_in="+t
...
return $("#UserID",e).length>0&&$("#PIN",e).length>0},retrieveStudentInfo:function(t,e,i){var r="https://jweb.kettering.edu/cku1/bwskrsta.P_RegsStatusDisp?term_in="+t
$.ajax({url:r,type:"GET",dataType:"html",success:function(t){if(KU.Student.JWEB.isErrorPage(t))return void i("Request failed")
var r,s,n,a,o,l,d,c,h,u,m,f=$("<div>").html(t),p=/(\d\d\d\d+)\s(.*)\n.*/,v=/Your\sClass\sfor\sregistration\spurposes\sis\s([a-zA-Z]+\s\d)\..*/,g=p.exec($(".staticheaders",f).text().trim())
r=null!=g&&3===g.length?g[2]:"",s=null!=g&&3===g.length?g[1]:"",n="",$(".pldefault",f).each(function(){var t=$(this).text().trim()
v.test(t)&&(n=v.exec(t)[1])}),a="",o="",l="",d="",c="",h="",u="",m=""
var x=function(t){return t.text().trim().toLowerCase()}
$(".datadisplaytable tr",f).each(function(t){if(3===$("td",this).size()){var e=$("td",this)
"undergraduate"===x(e.eq(0))&&"transfer"===x(e.eq(1))&&(a=e.eq(2).text().trim()),"undergraduate"===x(e.eq(0))&&"institutional"===x(e.eq(1))&&(o=e.eq(2).text().trim())}else"current program"===x($(this))&&t+1<$(".datadisplaytable tr",f).size()?l=$(".datadisplaytable tr",f).eq(t+1).text().trim():1===$("td",this).size()&&1===$("th",this).size()&&("college:"===x($("th",this).eq(0))?d=$("td",this).text().trim():"major:"===x($("th",this).eq(0))?(""!=c&&(c+=", "),c+=$("td",this).text().trim()):"minor:"===x($("th",this).eq(0))?(""!=u&&(u+=", "),u+=$("td",this).text().trim()):"concentration:"===x($("th",this).eq(0))?(""!=h&&(h+=", "),h+=$("td",this).text().trim()):"major concentration:"===x($("th",this).eq(0))&&(""!=m&&(m+=", "),m+=$("td",this).text().trim()))})
var b=new KU.Student.JWEB.StudentInfo(r,s,n,a,o,l,d,c,h,u,m)
...
n=!0
var c="http://www.bkstr.com/webapp/wcs/stores/servlet/CourseMaterialsResultsView?catalogId=10001&categoryId=9604&storeId=345405&langId=-1&programId=3663&termId="+o+"&divisionDisplayName=%20&departmentDisplayName="+l+"&courseDisplayName="+l+"%20"+d+"&sectionDisplayName="+i+"&demoKey=d&purpose=browse"
$.ajax({url:c,type:"GET",dataType:"html",timeout:25e3,success:function(t){var e=$("<div>").html(t),i=[],s=[]
...
$.ajax({url:r,type:"GET",dataType:"html",success:function(t){if(KU.Student.JWEB.isErrorPage(t))return void i("Request failed")
for(var r=$("<div>").html(t),s=$("table.datadisplaytable",r),n=[],a=0;a+1<s.size();a++){var o,l,d,c,h,u,m,f,p,v,g,x,b=s.eq(a),w=s.eq(a+1)
courseTitlePattern=/(.*)\s-\s(.*\s.*)\s-\s(\d\d)/
var _=function(t){return t.text().trim().toLowerCase()}
if(courseTitlePattern.test(b.find("caption:first").text().trim())&&w.find("caption:first").text().trim().indexOf("Scheduled Meeting Times")>-1){var y=courseTitlePattern.exec(b.find("caption:first").text().trim())
if(o=y[1],l=y[2].replace(" ","-"),d=y[3],c="",h="",u="",m="",f="",$("tbody tr",b).each(function(){1==$("th",this).size()&&1==$("td",this).size()&&("associated term:"===_($("th",this))?c=$("td",this).text().trim():"crn:"===_($("th",this))?h=$("td",this).text().trim():"assigned instructor:"===_($("th",this))?u=$("td",this).text().trim():"credits:"===_($("th",this))?m=$("td",this).text().trim():"campus:"===_($("th",this))&&(f=$("td",this).text().trim()))}),p="",v="",g="",x="",w.find("tr").size()>1)for(var q=1;q<w.find("tr").size();q++){var E=w.find("tr").eq(0),T=w.find("tr").eq(q)
E.find("th").size()==T.find("td").size()&&$("th",E).each(function(t){"schedule type"===_($(this))?p=$("td",T).eq(t).text().trim():"time"===_($(this))?v=$("td",T).eq(t).text().trim():"days"===_($(this))?g=$("td",T).eq(t).text().trim():"where"===_($(this))&&(x=$("td",T).eq(t).text().trim())}),n[n.length]=new KU.Student.JWEB.Course(o,l,d,c,h,u,m,f,p,v,g,x)}}}e(n)},error:function(t,e,r){i(r)}})}},e.BB={Contact:function(t,e,i){this.firstName=t,this.lastName=e,this.email=i},Grade:function(t,e,i,r,s,n,a){this.title=t,this.grade=e,this.pointsPossible=i,this.dueDate=r,this.postedDate=s,this.status=n,this.additionalInfo=a},Tree:function(t,e,i,r){return this.bbId=t,this.contentId=e,this.folders=i,this.items=r,this},Folder:function(t,i,r,s){return this.bbId=t,this.contentId=i,this.name=r,this.details=s,this.getContentTree=function(t,i){e.BB.retrieveContentTree(this.bbId,this.contentId,t,i)},this},Item:function(t,e,i){return this.name=t,this.details=e,this.fullBBId=i,this},Course:function(t,i,r,s,n,a,o,l){return this.courseId=t,this.term=i,this.crn=r,this.section=s,this.courseTitle=n,this.days=a,this.time=o,this.bbId=l,this.getContentTree=function(t,i){e.BB.retrieveContentTree(this.bbId,"",t,i)},this.getRoster=function(t,e){KU.Student.BB.retrieveRoster(this.bbId,t,e)},this.getGrades=function(t,e){KU.Student.BB.retrieveGrades(this.bbId,t,e)},this},retrieveGrades:function(t,i,r){var s="https://kettering.blackboard.com/webapps/bb-mygrades-BBLEARN/myGrades?course_id="+t+"&stream_name=mygrades"
...
if(n=[],l=[],a){var c,h
try{c=JSON.parse(i)}catch(u){return d=new e.BB.Tree(t,o,n,l),void r(d)}c.children.length>0&&(h=c.children[0].children)
...
var w=/.*folder_on.*/,_=/contentListItem:(_\d\d+_\d+)/,y=$(".courseId",b).text()
b.find("#content_listContainer > li").each(function(){if(_.test($(this).attr("id"))){var i=$("> img",this).attr("src"),r=_.exec($(this).attr("id"))[1],s=$("#"+r,this).text().trim(),a=$("> div.details",this).html()
w.test(i)?n[n.length]=new e.BB.Folder(t,r,s,a):l[l.length]=new e.BB.Item(s,a,y)}})}d=new e.BB.Tree(t,o,n,l),r(d)},error:function(t,e,i){s(i)}})},logout:function(t,i){var r="https://kettering.blackboard.com/webapps/login?action=logout"
...
if(s.test(i)&&r.test(t)){var o,l,d,c,h,u,m,f,p=r.exec(t)[1]
o=s.exec(i),l=o[1],d=o[2],c=o[3],h=o[4],u=o[5],m=o[6],f=o[7],n[n.length]=new e.BB.Course(l,d,c,h,u,m,f,p)}else if(a.test(i)&&r.test(t)){var o,l,d,c,h,u,m,f,p=r.exec(t)[1]
o=a.exec(i),l=o[1],d=o[2],c=o[3],u=o[4],h="TBD",m="TBD",f="TBD"
var v=new e.BB.Course(l,d,c,h,u,m,f,p)
...
a.sort(l)
for(var d=0,c=0;c<a.length;c++){var h,u,m,f,p,v,g,$,x,b,w=a[c]
...
o.sort(l)
for(var c=0;c<o.length;c++){var h,u,m,f,p,v,g,$,x,b,w=o[c]
u=t.toUpperCase()+"-"+r,m=w.course,f=w.course_title,g=w.college,$=w.college_code,x=w.course_city,b=w.course_state,v=new e(g,$,x,b),d[c]=new i(h,u,m,f,p,v)}s=null,a(d)},error:function(t,e,i){s=null,"abort"!=e&&o(i)}})},r.getColleges=function(t,i){var r="https://okras.kettering.edu/kuapps/apex_apps.transfer_art_pkg.get_json_ces_colleges",s=[]
